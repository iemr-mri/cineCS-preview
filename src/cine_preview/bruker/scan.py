...
class BrukerScan:
    ...
    Attributes:
        ...
        reco:      Reconstruction parameters from pdata/1/reco — notably
                   RECO_transposition, which controls the 2dseq pixel-axis layout.
    ...
    reco: dict[str, Any] = field(default_factory=dict)
